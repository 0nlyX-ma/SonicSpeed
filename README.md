# 🚀 SonicSpeed Pro - Firefox Extension

**SonicSpeed Pro** is a high-performance audio and video enhancement suite for Firefox. It allows users to take full control of their media experience with professional-grade audio tools.

## ✨ Features
- **Volume Ultra-Boost:** Amplify audio up to 600% using the Web Audio API.
- **Precision Speed Control:** Adjust playback from 0.1x to 16x speed.
